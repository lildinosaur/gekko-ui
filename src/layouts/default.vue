<template>
  <q-layout view="lHh Lpr fff">
    <q-header>
      <q-toolbar class="bg-blue-grey-7">
        ...
        <q-tabs shrink stretch>
          ...
          <q-route-tab icon="code" label="Strategies" to="/strategies" exact></q-route-tab>
    ...
    <q-footer reveal>
      <q-toolbar class="bg-blue-grey-7">
        <div>
          <div class="text-h8">Gordon UI v {{version.ui}}</div>
          <div class="text-subtitle">Running on Quasar v{{ $q.version }}</div>
        </div>
        <q-space></q-space>
        <q-space></q-space>
         <div>
          <div class="text-h8" v-if="version.gekko">Using Gekko v {{version.gekko}}</div>
        </div>
      </q-toolbar>
    </q-footer>
  </q-layout>
